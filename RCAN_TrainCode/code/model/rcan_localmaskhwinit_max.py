...
def make_model(args, parent=False):
    return RCAN_LocalMaskHWInit_Max(args)
...
class CALayer_LocalMaskHWInit_Max(nn.Module):
    def __init__(self, channel, mask_height, mask_width, reduction=16):
        super(CALayer_LocalMaskHWInit_Max, self).__init__()
...
class RCAB(nn.Module):
    def __init__(
        ...
        modules_body.append(CALayer_LocalMaskHWInit_Max(n_feat, mask_height, mask_width, reduction))
...
class RCAN_LocalMaskHWInit_Max(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(RCAN_LocalMaskHWInit_Max, self).__init__()
